...
import { IConfirmEmailRequest, IConfirmPhoneNumberRequest, IEmailConfirmationError, IResendConfirmationEmailRequest, IResendConfirmationSmsRequest, ISignUpRequest } from '../../interfaces';
